...
export default function Upload() {
  ...
  const uploadFile = async (fileWithMetadata: FileWithMetadata) => {
    ...
    try {
      ...
      const fileName = `${user!.id}/${selectedSubjectId}/${Date.now()}_${
        file.name
      }`;
      ...
      setFiles((prev) =>
        prev.map((f) =>
          f.id === id ? { ...f, status: "processing", progress: 60 } : f
        )
      );
        ...
        {files.length === 0 && selectedSubjectId && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
              ...
              <li>
                Supported formats: PDF, DOCX, PPTX, images, and text files
              </li>
              <li>
                We'll automatically extract text and analyze your materials
              </li>
